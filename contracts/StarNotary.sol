...
contract StarNotary is ERC721 {
    ...
    string public constant tokenName = "Alamin";
    ...
    function lookUptokenIdToStarInfo(uint _tokenId) public view returns (string memory) {
        ...
        require(bytes(tokenIdToStarInfo[_tokenId].name).length > 0, "we can not find star with given ID");
        // was not able to find away to test the above line.
